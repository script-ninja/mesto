...
const toggleSubmitState = function (inputList, submitButton, {submitDisabledClass, ...rest}) {
  submitButton.classList[hasInvalidInput(inputList) ? 'add' : 'remove'](submitDisabledClass);
}
...
const setInputListeners = function (form, {inputSelector, submitSelector, ...rest}) {
